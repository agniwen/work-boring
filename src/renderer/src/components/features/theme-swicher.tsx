...
function ThemeSwitcher() {
  ...
  return (
    <motion.div
      ...
      className='inline-flex w-fit items-center overflow-hidden rounded-full bg-white opacity-40! transition-opacity ring-inset hover:opacity-100! dark:bg-zinc-950 dark:ring-zinc-700'
      role='radiogroup'
    >
