        ...
        <div className='grid gap-4 xl:grid-cols-[minmax(0,1.8fr)_minmax(320px,1fr)]'>
          <Card>
            <CardHeader className='flex items-start justify-between gap-4 p-5'>
              <div>
                <CardTitle>最近 14 天趋势</CardTitle>
                <CardDescription>橙色是 token 消耗，蓝色是 prompt 次数。</CardDescription>
              </div>
              <Badge variant='secondary'>{summary?.daily.length ?? 0} points</Badge>
            </CardHeader>
                    ...
                    >
                      ...
                      <Tooltip
                        ...
                        content={({ active, label, payload }) => {
                          ...
                          return (
                            <div className='rounded-2xl border border-border bg-popover px-3 py-2 shadow-lg backdrop-blur'>
                              <div className='text-xs font-medium text-muted-foreground'>
                                {formatDate(String(label ?? ''))}
                              </div>
                              <div className='mt-2 space-y-1 text-sm text-popover-foreground'>
          ...
          <Card>
            <CardHeader className='p-5'>
              <CardTitle>最后一次聊天会话</CardTitle>
              <CardDescription>已删除的会话不会出现在这里。</CardDescription>
            </CardHeader>
                ...
                <div className='space-y-4'>
                  <div className='space-y-3 rounded-2xl border p-4'>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      ...
                      <Badge variant='secondary'>{summary.latestSession.status}</Badge>
                    </div>
                  </div>
